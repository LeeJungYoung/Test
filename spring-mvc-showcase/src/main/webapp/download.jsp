...
<% 
	...
	String realFolder = context.getRealPath("c:\\upload-dir");
	String realFolder2 = context.getRealPath("c:\\upload-dir");
	
	String filePath = "c:\\upload-dir\\" + fileName;
	String filePath2 = "c:\\upload-dir\\" + fileName;
	System.out.println(realFolder + " 파일을 다운로드");
